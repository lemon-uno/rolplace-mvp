    ...
    <footer className="border-t border-gray-200" style={{ backgroundColor: '#f3f7fc' }}>
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              <a
                href="https://facebook.com/rolplace"
                target="_blank"
              ...
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.77,7.46H14.5v-1.9c0-.9.6-1.1,1-1.1h3V.5L14.5.5C10.45.5,9.5,3.09,9.5,5.27v2.19H6.77v4h2.73V22h5V11.63h3.36l.43-4Z" />
                </svg>
              </a>
              <a
              ...
              <a
                href="https://instagram.com/rolplace"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 flex items-center justify-center bg-gradient-to-br from-purple-600 via-pink-600 to-orange-500 text-white rounded-full hover:opacity-90 transition-opacity"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3 text-gray-600">
                ...
                <span>contacto@rolplace.com</span>
              </li>
              <li className="flex items-center gap-3 text-gray-600">
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 text-center text-gray-600 text-sm">
          <p>© 2026 Rolplace. Todos los derechos reservados. Desarrollado por Lemon Uno</p>
        </div>
      </div>
    </footer>
  );
